...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchQuotations = async () => {
            try {
                const response = await fetch('https://eunivate-backend-56iw.onrender.com/api/users/quotations');
    ...
    const handleDelete = async () => {
        try {
            await Promise.all(selectedIds.map(id => 
                fetch(`https://eunivate-backend-56iw.onrender.com/api/users/quotations/${id}`, {
                    method: 'DELETE',
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                const response = await fetch('https://eunivate-backend-56iw.onrender.com/api/users/stats');
                const data = await response.json();
                setStats([
